...
// marking this class as a spring component (bean) and giving it a custom name 'objLap'
@Component("objLap")
//@Primary // If uncommented, this will make Laptop the primary bean for injection when no specific bean is requested
public class Laptop implements Computer {

    // implementation of the 'compile' method defined in the Computer interface
    @Override
    public void compile() {
        // printing a message to indicate that the compile method is being executed in the Laptop class
